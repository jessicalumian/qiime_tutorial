...
**FOR MBL REAL TUTORIAL USE THIS COMMAND**

```text
core_diversity_analyses.py -o cdout/ -i OTU_table_singletonfiltered.biom -m A_mapping.txt -e 1114
make_emperor.py -i cdout/bdiv_even1114/bray_curtis_pc.txt -o cdout/bdiv_even1114/bray_curtis_emperor_pcoa_plot/ -m A_mapping.txt --ignore_missing_samples
```
